...
- [TylerMorrison21/paperflow-mcp](https://github.com/TylerMorrison21/paperflow-mcp) 📇 ☁️ - MCP server for Claude that converts academic PDFs into clean Markdown with LaTeX, figures, tables, and citation footnotes for AI research workflows.
